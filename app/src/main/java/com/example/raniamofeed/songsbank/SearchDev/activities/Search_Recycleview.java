...
public class Search_Recycleview extends AppCompatActivity implements RecyclerViewAdapter.OnItemClick{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_search__recycleview);
    ...
    public void onClick(Songs songs) {
        ...
        intent.putExtra("User_ID" , Url.getIduser());
